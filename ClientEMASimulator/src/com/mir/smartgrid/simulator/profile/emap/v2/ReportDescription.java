...
public class ReportDescription {
	...
	public String toString() {
		...
		if (qos != null) {
			...
			return "{\"rID" + "\":" + "\"" + getrID() + "\"" + ", " + "\"resourceID" + "\":" + "\"" + getResouceID()
					+ "\"" + ", " + "\"deviceType" + "\":" + "\"" + getDeviceType() + "\"" + ", " + "\"reportType"
					+ "\":" + "\"" + getReportType() + "\"" + ", " + "\"itemUnits" + "\":" + "\"" + getItemUnits()
					+ "\"" + ", " + "\"siScaleCode" + "\":" + "\"" + getSiScaleCode() + "\"" + ", " + "\"marketContext"
					+ "\":" + "\"" + getMarketContext() + "\"" + ", " + "\"minPeriod" + "\":" + "\"" + getMinPeriod()
					+ "\"" + ", " + "\"maxPeriod" + "\":" + "\"" + getMaxPeriod() + "\"" + ", " + "\"onChange" + "\":"
					+ "\"" + isOnChange() + "\"" + ", " + "\"itemDescription" + "\":" + "\"" + getItemDescription()
					+ "\"" + ", " + "\"powerAttributes" + "\":" + getPowerAttributes() + ", " + "\"state" + "\":" + "\""
					+ getState() + "\"" + ", " + "\"power" + "\":" + getPower() + ", " + "\"dimming" + "\":"
					+ getDimming() + ", " + "\"qos" + "\":" + "\"" + getQos() + "\"" + ", " + "\"margin" + "\":"
					+ getMargin() + ", " + "\"generate" + "\":" + getGenerate() + ", " + "\"storage" + "\":"
					+ getStorage() + ", " + "\"maxValue" + "\":" + getMaxValue() + ", " + "\"minValue" + "\":"
					+ getMinValue() + ", " + "\"avgValue" + "\":" + getAvgValue() + ", " + "\"maxValue" + "\":"
					+ getMaxValue() + ", " + "\"time" + "\":" + "\"" + getTime() + "\"" + ", " + "\"maxTime" + "\":"
					+ "\"" + getMaxTime() + "\"" + ", " + "\"minTime" + "\":" + "\"" + getMinTime() + "\"" + ", "
					+ "\"priority" + "\":" + "\"" + getPriority() + "\"" + "}";

			// json.put("rID", getrID());
			// json.put("resourceID", getResouceID());
			// Qjson.put("deviceType", getDeviceType());
			...
			return "{\"rID" + "\":" + "\"" + getrID() + "\"" + ", " + "\"resourceID" + "\":" + "\"" + getResouceID()
					...
					+ "\"" + ", " + "\"powerAttributes" + "\":" + getPowerAttributes() + ", " + "\"state" + "\":" + "\""
					+ getState() + "\"" + ", " + "\"power" + "\":" + "\"" + getPower() + "\"" + ", " + "\"dimming"
					+ "\":" + "\"" + getDimming() + "\"" + ", " + "\"margin" + "\":" + "\"" + getMargin() + "\"" + ", "
					+ "\"generate" + "\":" + "\"" + getGenerate() + "\"" + ", " + "\"storage" + "\":" + "\""
					+ getStorage() + "\"" + ", " + "\"maxValue" + "\":" + "\"" + getMaxValue() + "\"" + ", "
					+ "\"minValue" + "\":" + "\"" + getMinValue() + "\"" + ", " + "\"avgValue" + "\":" + "\""
					+ getAvgValue() + "\"" + ", " + "\"time" + "\":" + "\"" + getTime() + "\"" + ", " + "\"maxTime"
					+ "\":" + "\"" + getMaxTime() + "\"" + ", " + "\"minTime" + "\":" + "\"" + getMinTime() + "\""
					+ ", " + "\"priority" + "\":" + "\"" + getPriority() + "\"" + "}";
	...
	public ReportDescription addReportDescriptionParams(String rID, String resourceID, String deviceType,
		...
		// System.out.println("?ù¥Í±∞ÏΩú?ñáÏß??");
